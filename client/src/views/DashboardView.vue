  ...
  <div class="dashboard-bg relative min-h-screen overflow-x-hidden font-festive text-dusk">
    ...
    <div class="relative z-10 mx-auto max-w-3xl px-4 py-10 sm:px-8 sm:py-14 xl:max-w-6xl">
      <header class="reveal mb-10 text-center" style="animation-delay: 0s">
        ...
        <p class="toon-text font-carnival text-base uppercase tracking-[0.15em] text-toon sm:text-lg">Zánka 2026</p>
        <h1 class="toon-text font-carnival text-4xl text-toon sm:text-6xl">Az állás</h1>
      </header>
      ...
      <template v-else>
        <div class="mb-14 space-y-14 xl:grid xl:grid-cols-2 xl:items-start xl:gap-8 xl:space-y-0">
          <section v-if="teams.length" class="reveal" style="animation-delay: 0.1s">
            <div v-if="isFaceOff" class="relative grid grid-cols-2 gap-3 sm:gap-6">
              ...
              <div
                class="absolute left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 rotate-6 rounded-full border-4 border-dusk bg-toon px-3 py-1.5 font-carnival text-sm text-dusk shadow-toon sm:px-5 sm:py-2.5 sm:text-xl"
              >
                VS
              </div>
            </div>
          ...
          <section v-if="topPeople.length" class="reveal" style="animation-delay: 0.3s">
            <h2 class="toon-text mb-4 text-center font-carnival text-2xl text-toon sm:text-3xl">Legjobb 3 játékos</h2>
            <div class="space-y-3">
              <div
      ...
      <footer class="mt-14 text-center text-sm font-bold text-dusk/60">
